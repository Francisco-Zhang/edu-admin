...
public class Md5 {
     ...
     */
    public String md532(String inbuf) {
        md5Init();
    ...
    public String md516(String inStr) {
        Md5 md5 = new Md5();
        String tmp = md5.md532(inStr);
    ...
    public String get32LowerCase(String password) {
        if(StringUtils.isNotBlank(password)) {
            return this.md532(password).toLowerCase();
        }else{
            return null;
        }
    }
    public String get32UpperCase(String password) {
        if(StringUtils.isNotBlank(password)) {
            return this.md532(password);
        }else{
            return null;
        }
    }
    public String get16LowerCase(String password) {
        if(StringUtils.isNotBlank(password)) {
            return this.md516(password).toLowerCase();
        }else{
            return null;
        }
    }
    public String get16UpperCase(String password) {
        if(StringUtils.isNotBlank(password)) {
            return this.md516(password);
        }else{
            return null;
        }
    }
